...
async def show_main_menu(message: types.Message, lang: str, paid: bool, is_start: bool = False):
    ...
    if lang == "en":
        if paid:
            ...
            text += "• 🔥 RARE signals (best setups, 95%+)\n"
            text += "• ⚡ HIGH signals (strong setups, 80-94%)\n"
            text += "• Full TP1/TP2/TP3 + Stop Loss\n"
            text += "• Auto updates (entry, TP hit, SL)\n"
            text += "• 🎯 Choose your coins\n\n"
            text += "🧠 <b>Important:</b>\n"
        ...
        if paid:
            ...
            text += "• 🔥 RARE сигналы (лучшие сетапы, 95%+)\n"
            text += "• ⚡ HIGH сигналы (сильные сетапы, 80-94%)\n"
            text += "• Полные TP1/TP2/TP3 + Stop Loss\n"
            text += "• Авто-апдейты (вход, TP, SL)\n"
            text += "• 🎯 Выбор своих монет\n\n"
            text += "🧠 <b>Важно:</b>\n"
            text += "Качество важнее количества.\n"
